...
<body class="h-screen bg-white flex items-center justify-center">
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-lg">
            <h1 class="text-center text-2xl font-bold text-green-600 sm:text-3xl">Buat Akun</h1>
            ...
            <form action="#" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                ...
                <a href="{{ route('dashboard') }}" type="submit"
                    class="text-center block w-full rounded-lg bg-green-600 px-5 py-3 text-sm font-medium text-white">
                    Login
                </a>
