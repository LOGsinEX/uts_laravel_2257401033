...
<body class="h-full">
    ...
    <section class="relative bg-cover bg-center bg-no-repeat"
        style="background-image: url('{{ asset('images/piksi.png') }}');">
        ...
        <div
            ...
            <div class="bg-gray-900/75 px-7 py-12 max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                <h1 class="text-3xl font-extrabold text-white sm:text-5xl">
                    ...
                    <strong class="block font-extrabold text-green-500"> {{ $nim }} - {{ $kelas }}
                    </strong>
                </h1>
                ...
                <div class="justify-center mt-8 flex flex-wrap gap-4 text-center">
                    ...
                    <a href="{{ route('welcome') }}"
                        class="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-green-600 shadow hover:text-rose-700 focus:outline-none focus:ring active:text-rose-500 sm:w-auto">
                        Logout
                    </a>
                </div>
            </div>
